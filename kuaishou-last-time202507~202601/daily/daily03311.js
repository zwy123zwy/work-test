...
const questionBank = [
  ...
  { id: '3311.5', section: 3311, type: 'design', title: '场景设计：AI 搜索建议', prompt: '设计一个 AI 搜索建议输入框，要求不卡顿、少请求、可中断过时请求。', code: null, answer: '核心方案：输入防抖 + AbortController 取消过时请求 + 本地缓存 + 最近热词兜底 + 错误降级。AI 补充：离线关键词纠错与同义词扩展。', answerCode: null },
  ...
  { id: '3311.10', section: 3311, type: 'design', title: '场景设计：AI 客服分流', prompt: '设计 AI 客服前端分流，包含人工兜底。', code: null, answer: '方案：意图识别 -> 置信度阈值分流；低置信度/情绪异常直接转人工；会话上下文脱敏；请求链路埋点。AI 补充：引入澄清问题策略减少误分流。', answerCode: null },
  ...
  { id: '3311.15', section: 3311, type: 'design', title: '场景设计：AI 打字机效果', prompt: '流式输出时如何稳定渲染并自动滚动？', code: null, answer: '分批渲染（rAF/时间片）、虚拟列表、接近底部才自动滚动、用户上滑则暂停自动滚动。AI 补充：基于 token 速率动态调节批次。', answerCode: null },
  ...
  { id: '3311.20', section: 3311, type: 'design', title: '场景设计：AI 推荐解释性', prompt: '设计“推荐理由”前端展示，避免误导。', code: null, answer: '展示可解释字段（最近行为、相似用户维度）、可信度标签、可关闭/纠错入口。AI 补充：理由模板+风险词过滤，减少“幻觉解释”。', answerCode: null },
];
