...
const questionBank = [
  ...
  { id: '3314.5', section: 3314, type: 'design', title: '场景设计：AI 请求链路监控', prompt: '前端如何定位“回答慢/失败”问题？', code: null, answer: '记录 DNS/TCP/TTFB/流式首包/首 token 时间、模型耗时、重试次数。AI 补充：异常样本自动聚类定位根因。', answerCode: null },
  ...
  { id: '3314.10', section: 3314, type: 'design', title: '场景设计：AI 多端一致性', prompt: 'Web/H5/小程序如何共享会话状态？', code: null, answer: '统一会话 API、版本号、增量同步、冲突按时间戳合并。AI 补充：上下文摘要同步降低带宽。', answerCode: null },
  ...
  { id: '3314.15', section: 3314, type: 'design', title: '场景设计：AI 内容安全前端兜底', prompt: '服务端审核前，前端做什么？', code: null, answer: '本地规则初筛、敏感词高亮、提交前二次确认。AI 补充：上下文风险评分提示用户改写。', answerCode: null },
  ...
  { id: '3314.20', section: 3314, type: 'design', title: '场景设计：AI 大模型失败降级', prompt: '回答失败时如何兜底不影响体验？', code: null, answer: '按错误类型降级：重试->备用模型->模板答案->人工入口；保留用户输入与上下文。AI 补充：失败样本回灌训练。', answerCode: null },
];
